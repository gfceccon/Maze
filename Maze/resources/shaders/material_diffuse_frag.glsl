...
// Textures usage
//vec3 ambient = light.ambient * vec3(texture(material.diffuse2D2D, TexCoord));
//vec3 diffuse = light.diffuse * diff * vec3(texture(material.diffuse2D2D, TexCoord));
//vec3 specular = light.specular * spec * vec3(texture(material.specular2D2D, TexCoord));
